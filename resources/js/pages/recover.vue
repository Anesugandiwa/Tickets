<script setup>
const recover= () =>{
    this.form.get('/recovert-ticket/'+this.form.ref_no)
}
</script>
<template>
    <v-container>
         <div class="glass">
               ...
               <v-form @submit.prevent="">
                <v-card class="mt-5 mx-auto" max-width="550">
                    ...
                    <v-card-text>
                       ...
                       <v-card-actions>
                        <v-btn :disabled="!form.ref_no" :loading="form.processing" type="submit" size="x-large" rounded block variant="flat">
                            Submit & Recover
                        </v-btn>
                       </v-card-actions>
